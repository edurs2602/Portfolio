const About = () => {
    return (
        <div className="h-10vh lg:flex justify-between z-50 text-white lg:py-5 lg:px-20 px-5 py-10 gap-10 flex-1 lg:gap-16">
            <div className="h-full lg:py-40 flex flex-col lg:justify-center lg:items-start items-start text-black">
            ...
            <div data-aos="fade-left" className="h-full lg:py-40 flex flex-col justify-between lg:items-start items-center text-black">
                ...
                <h1 className="text-2xl font-light leading-11">Hoje, formado pelo IFRN e com uma ótima base em desenvolvimento, continuei meus passos e estou no bacharelado em Tecnologia da Informação no Instituto Metropole Digital. Tenho interesse na área de engenharia de software, arquitetura de software, infraestrutura de software e em áreas relacionadas a Blockchain.</h1>
            </div>
        </div>
    );
};
